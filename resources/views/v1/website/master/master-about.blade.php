...
<head>
  ...
  @include('v1/website/components/css/about_css')
</head>

<body class="page-template-default page page-id-10 wp-custom-logo woocommerce-no-js woocommerce-wishlist woocommerce woocommerce-page no-sidebar fullwidth-layout header-layout1 es-product-layout1 woocommerce-active elementor-default elementor-page elementor-page-10">
